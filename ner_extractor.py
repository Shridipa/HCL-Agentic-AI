...
def extract_entities(query):
    ...
    # Heuristic: Only run zero-shot for likely relevant slots to save time
    likely_slots = []
    ...
    # If no heuristics hit, check all (or stick to a default set)
    ...
    it_keywords = ['broken', 'issue', 'laptop', 'access', 'failed', 'problem', 'reset', 'password', 'slow', 'flickering', 'ticket']
